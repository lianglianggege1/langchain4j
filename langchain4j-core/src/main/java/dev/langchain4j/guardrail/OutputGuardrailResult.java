 ...
 */
/**
 * 表示 {@link OutputGuardrail} 输出护栏的校验结果。
 */
public final class OutputGuardrailResult implements GuardrailResult<OutputGuardrailResult> {
     ...
     * 生成包含指定成功信息文本的校验成功结果
     *
     * @param successfulText 成功结果的文本信息
     ...
     * 生成包含指定成功信息文本的校验成功结果
     *
     * @param successfulAiMessage 表示成功结果的 AI 消息对象
     ...
     * 生成非致命性失败结果
     *
     * @param failures 失败信息 {@link Failure} 列表
     * @return 输出护栏校验失败的结果
     */
